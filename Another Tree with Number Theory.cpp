...
#define pass(x,y) fixed<<setprecision(y)<<x
#define sieze(x) ((ll)(x).size())
#define pos_rt_stbt(x) (__builtin_ffsll(x))   
#define fst ios_base::sync_with_stdio(false);cin.tie(nullptr);cout.tie(nullptr)
#define sbts(x) __builtin_popcountll(x)
#define zbts(x) __builtin_ctzll(x)
